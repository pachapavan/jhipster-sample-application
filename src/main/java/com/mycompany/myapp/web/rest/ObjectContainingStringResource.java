...
import com.mycompany.myapp.repository.ObjectContainingStringRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.ObjectContainingString}.
 */
@RestController
@RequestMapping("/api")
@Transactional
