...
import com.mycompany.myapp.domain.BusRoute;
import com.mycompany.myapp.repository.BusRouteRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.BusRoute}.
 */
@RestController
@RequestMapping("/api")
@Transactional
