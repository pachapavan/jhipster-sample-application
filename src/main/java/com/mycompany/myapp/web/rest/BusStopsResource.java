...
import com.mycompany.myapp.domain.BusStops;
import com.mycompany.myapp.repository.BusStopsRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.BusStops}.
 */
@RestController
@RequestMapping("/api")
@Transactional
